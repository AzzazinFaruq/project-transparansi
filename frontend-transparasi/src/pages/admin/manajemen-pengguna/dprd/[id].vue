  ...
  <div>
    <v-card class="pa-5">
      <div class="d-flex justify-space-between align-center mb-5">
        <div>
          <p class="text-h5 font-weight-bold">Edit Pengguna DPRD</p>
          <p class="text-subtitle-1 text-grey">Edit informasi pengguna DPRD</p>
        </div>
        <v-btn 
          color="error" 
          @click="back()"
      ...
      <v-row>
        <v-col cols="12" md="8">
          <v-form>
            ...
            <div class="mb-5">
              <label class="label-form mb-2 d-block">Jabatan</label>
              <v-select
